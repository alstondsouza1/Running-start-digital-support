export const prospectiveStudentsQuestions = [
  ...
  },
  {
    ...
    answer: {
      bullets: [
        {
          text:
            "Yes, if students take assessment at another college a Green River Running Start Advisor will need to review the scores (scores must be less than two years old).",
        },
      ],
    },
  },
  ...
  // ----------------------------
  {
    ...
    answer: {
      intro:
        "All qualified students can enroll for three terms (Fall, Winter, and Spring) during their junior year and three terms (Fall, Winter, and Spring) during their senior year. There are special circumstances that can allow students to:",
      bullets: [
  ...
  },
  {
    ...
    answer: {
      bullets: [
        {
          text:
            "The student will not be able to participate in the Running Start program for the term. Students must be enrolled in courses by the third day of the term.",
        },
      ],
    },
  },
  ...
  },
  {
    ...
    answer: {
      bullets: [
        {
          text:
            "Please visit the Placement section of our site for information on advising and placement. Most Running Start students place either through the high school transcripts or the WAMAP placement test.",
